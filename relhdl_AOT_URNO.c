...
static char mks_version[] = "@(#) "UFIS_VERSION" $Id: Ufis/_Standard/_Standard_Server/Base/Server/Kernel/relhdl.c 1.14d 2015/02/02 15:03:03SGT fya Exp  $";
...
/* 20150202 FYA: v1.14d UFIS-8295 HOPO implementation                         */
/*                                                                            */
/******************************************************************************/
/*                                                                            */
...
static int Init_relhdl() {
    ...
    InitRecordDescriptor(&rgDbUrnoList, (1024 * URNO_LEN), 0, TRUE);
