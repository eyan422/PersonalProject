  ...
  static char mks_version[] = "@(#) "UFIS_VERSION" $Id: Ufis/_Standard/_Standard_Server/Base/Server/Kernel/hwecon.c 1.72bb 19/11/2014 2:27:07 PM Exp  $";
...
//
static int igTestMultiple = FALSE;
//
...
static int FindMsgType(char *pcpData, char *pcpMsgType, int Mode);
/******************************************************************************/
/*                                                                            */
/* The MAIN program                                                           */
/*                                                                            */
...
static int GetConfig()
{
	...
	*/
	...
	ilRC = iGetConfigEntry(pcgConfigFile,"MAIN","TEST_MULTIPLE",CFG_STRING,pclTmpBuf);
    if ((ilRC == RC_SUCCESS) && (strcmp(pclTmpBuf, "YES") == 0))
    {
        igTestMultiple = TRUE;
		dbg(TRACE,"Test multiple enabled");
    }
    else
    {
        igTestMultiple = FALSE;
	    dbg(TRACE,"Test multiple disabled");
    }
...
static int Receive_data(int ipSock,int ipTimeOut)
{
	...
	char pclTmpTypeBuf[256] = "\0";

	char pclExtractedData[1024*4] = "\0";
	...
	char pcgTestData[] = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"1\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-11-16T05:34:31.442Z\" messageStamp=\"2014-11-16T05:34:31.442Z\" ><flightRecord URNO=\"10862515\" typeOfOperation=\"U\" ><LNDDIR>30R</LNDDIR></flightRecord></message><?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"1\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-11-16T05:34:31.442Z\" messageStamp=\"2014-11-16T05:34:31.442Z\" ><flightRecord URNO=\"10862515\" typeOfOperation=\"U\" ><LNDDIR>31R</LNDDIR></flightRecord></message><?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"1\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-11-16T05:34:31.442Z\" messageStamp=\"2014-11-16T05:34:31.442Z\" ><flightRecord URNO=\"10862515\" typeOfOperation=\"U\" ><LNDDIR>32R</LNDDIR></flightRecord></message><?xml version='1.0' encoding='UTF-8'?><message messageType=\"acknowledge\" recipientId=\"ufis\" version=\"4.3\" senderId=\"aglcms\" sourceStamp=\"2014-10-30T06:45:40.633Z\" messageStamp=\"2014-10-30T06:45:40.633Z\" messageId=\"734\" ><acknowledge messageId=\"734\" /></message><?xml version='1.0' encoding='UTF-8'?><message messageType=\"acknowledge\" recipientId=\"ufis\" version=\"4.3\" senderId=\"aglcms\" sourceStamp=\"2014-10-30T06:45:40.750Z\" messageStamp=\"2014-10-30T06:45:40.750Z\" messageId=\"735\" ><acknowledge messageId=\"735\" /></message><message messageType=\"heartbeat\" recipientId=\"ufis\" version=\"4.3\" senderId=\"aglcms\" sourceStamp=\"2014-10-30T06:28:56.407Z\" messageStamp=\"2014-10-30T06:28:56.407Z\" messageId=\"0\" ><heartbeat><timeout>10</timeout></heartbeat></message><message messageType=\"heartbeat\" recipientId=\"ufis\" version=\"4.3\" senderId=\"aglcms\" sourceStamp=\"2014-10-30T06:28:56.407Z\" messageStamp=\"2014-10-30T06:28:56.407Z\" messageId=\"0\" ><heartbeat><timeout>10</timeout></heartbeat></message><?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"1\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-11-16T05:34:31.442Z\" messageStamp=\"2014-11-16T05:34:31.442Z\" ><flightRecord URNO=\"10862515\" typeOfOperation=\"U\" ><LNDDIR>30L</LNDDIR></flightRecord></message><?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"1\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-11-16T05:34:31.442Z\" messageStamp=\"2014-11-16T05:34:31.442Z\" ><flightRecord URNO=\"10862515\" typeOfOperation=\"U\" ><LNDDIR>31L</LNDDIR></flightRecord></message><?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"1\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-11-16T05:34:31.442Z\" messageStamp=\"2014-11-16T05:34:31.442Z\" ><flightRecord URNO=\"10862515\" typeOfOperation=\"U\" ><LNDDIR>32L</LNDDIR></flightRecord></message><?xml version='1.0' encoding='UTF-8'?><message messageType=\"acknowledge\" recipientId=\"ufis\" version=\"4.3\" senderId=\"aglcms\" sourceStamp=\"2014-10-30T06:45:40.750Z\" messageStamp=\"2014-10-30T06:45:40.750Z\" messageId=\"736\" ><acknowledge messageId=\"736\" /></message><?xml version='1.0' encoding='UTF-8'?><message messageType=\"acknowledge\" recipientId=\"ufis\" version=\"4.3\" senderId=\"aglcms\" sourceStamp=\"2014-10-30T06:45:40.750Z\" messageStamp=\"2014-10-30T06:45:40.750Z\" messageId=\"737\" ><acknowledge messageId=\"737\" /></message><?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"1\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-11-16T05:34:31.442Z\" messageStamp=\"2014-11-16T05:34:31.442Z\" ><flightRecord URNO=\"10862515\" typeOfOperation=\"U\" ><LNDDIR>33R</LNDDIR></flightRecord></message><?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"1\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-11-16T05:34:31.442Z\" messageStamp=\"2014-11-16T05:34:31.442Z\" ><flightRecord URNO=\"10862515\" typeOfOperation=\"U\" ><LNDDIR>33R</LNDDIR></flightRecord></message><?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"1\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-11-16T05:34:31.442Z\" messageStamp=\"2014-11-16T05:34:31.442Z\" ><flightRecord URNO=\"10862515\" typeOfOperation=\"U\" ><LNDDIR>33R</LNDDIR></flightRecord></message><?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"39\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-04-27T13:57:41.990Z\" messageStamp=\"2014-04-27T13:57:41.990Z\" ><flightRecord URNO=\"1621973168\" typeOfOperation=\"U\" ><EETT>2014-04-27T12:18:03.000Z</EETT><AETT>2014-04-27T12:21:54.000Z</AETT><EXOT>PT647S</EXOT></flightRecord></message><?xml version=\"1.0\" encoding=\"UTF-8\"?><message version=\"4.3\" messageId=\"36\" messageType=\"flightRecord\" recipientId=\"ufis\" senderId=\"aglcms\" sourceStamp=\"2014-04-27T13:53:36.535Z\" messageStamp=\"2014-04-27T13:53:36.535Z\" ><flightRecord URNO=\"2032837725\" typeOfOperation=\"U\" ><VIS>10</VIS></flightRecord></message>";
		...
		default:
			...
			else
			{
				if(FD_ISSET( ipSock, &readfds))
				{
					...
					//
					if(igTestMultiple == TRUE)
					{
						dbg(DEBUG,"igTestMultiple is enabled");
						ilNo = 1;
						strcpy(pclRecvBuffer,pcgTestData);
					}
					//
		    	  ...
		    	  if( ilNo > 0 )
		          {
						//
						pclP   = pclRecvBuffer;
						pclTmp = pclRecvBuffer;
						//

		      	        //if(strstr(pclRecvBuffer,"heartbeat") == 0)
		      	            dbg(TRACE,"<%s> Len<%d>Complete message<%s>",pclFunc,ilNo,pclRecvBuffer);

						while( pclP!= NULL && pclTmp!=NULL)
						{
							if (pclTmp!=NULL && *pclTmp!='0' && strlen(pclTmp)>0)
							{
								(void) FindMsgId(pclP, pclTmpBuf, 0);
								(void) FindMsgType(pclP, pclTmpTypeBuf, 0);
								dbg(DEBUG,"\n\n[%d]----Received the ack messageId<%s> type<%s>", i++,pclTmpBuf,pclTmpTypeBuf);
							}

							if(strcmp(pclTmpTypeBuf,"acknowledge")==0 || strcmp(pclTmpTypeBuf,"heartbeat")==0)
							{
								if(atoi(pclTmpBuf)>0) //ack
								{
									dbg(DEBUG,"<%s> Received the ack message",pclFunc);
									dbg(DEBUG,"<%s> pcgSendMsgId<%s> pclTmpBuf<%s>",pclFunc,pcgSendMsgId,pclTmpBuf);
							...
							{//XMLI
								...
								if (strcmp(pcgMsgNoForACK, "0") != 0 )
								{
									...
									/**/
									memset(pclExtractedData,0,sizeof(pclExtractedData));

									if(strstr(pclP,pclTag) != NULL)
									{
										strncpy(pclExtractedData, pclP,(strstr(pclP,pclTag) - pclP));
										pclExtractedData[strstr(pclP,pclTag) - pclP] = '\0';

										//ilRC = SendCedaEvent(igModID_Rcvr,0,mod_name,"CEDA",pcgTwStart,pcgTwEnd,"XMLI","",pcgMsgNoForACK,"",pclRecvBuffer,"","",NETOUT_NO_ACK);

										ilRC = SendCedaEvent(igModID_Rcvr,0,mod_name,"CEDA",pcgTwStart,pcgTwEnd,"XMLI","",pcgMsgNoForACK,"",pclExtractedData,"","",NETOUT_NO_ACK);
									}
									else
									{
										if(pclP!=NULL && strlen(pclP)>0)
										{
											ilRC = SendCedaEvent(igModID_Rcvr,0,mod_name,"CEDA",pcgTwStart,pcgTwEnd,"XMLI","",pcgMsgNoForACK,"",pclP,"","",NETOUT_NO_ACK);
										}
									}
							...
							pclTmp = strstr(pclP,pclTag);

							if(pclTmp == NULL || pclTmp[0]=='0' || pclP[0] =='0')
								break;
...
static int FindMsgType(char *pcpData, char *pcpMsgType, int Mode)
{
    ...
    if (pclMsgIdBgn != NULL)
    {
        ...
        if ((pclMsgIdBgn != NULL) && (pclMsgIdEnd >= pclMsgIdBgn))
        {
            ...
            pclTmpBuf[pclMsgIdEnd - pclMsgIdBgn] = '\0';
            //ilMsgId = atoi(pclTmpBuf);
            dbg(DEBUG,"<%s> Received the message type <%s>",pclFunc, pclTmpBuf);
        }
    }
    sprintf(pcpMsgType, "%s", pclTmpBuf);
	return ilRC;
}
