  ...
  static char mks_version[] = "@(#) "UFIS_VERSION" $Id: Ufis/_Standard/_Standard_Server/Base/Server/Kernel/lighdl.c 2.8 08/08/2014 12:59 PM Exp  $";
		...
		case NOTFOUND:
            ...
            switch(ilRC)
            {
                ...
                default:
                    ...
                    FindNextAllocTowingArrBuildFullQuery(pclSqlBuf,pclWhere);
