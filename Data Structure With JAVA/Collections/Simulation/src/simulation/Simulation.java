...
public class Simulation {
	...
	public Simulation()
	{
		...
		*/
		...
		System.out.printf("Number of servers:", SERVERS);
		System.out.printf("Number of clients:", CLIENTS);
		System.out.printf("Mean service time:", MEAN_SERVICE_TIME);
		System.out.printf("Mean interarrival time:", MEAN_ARRIVAL_TIME);
