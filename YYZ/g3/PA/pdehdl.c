  ...
  static char mks_version[] = "@(#) "UFIS_VERSION" $Id: Ufis/_Standard/_Standard_Server/Base/Server/Kernel/pdehdl.c 1.22 2013/02/07 9:52:56SGT fya Exp  $";
...
/* static char sccs_version[] ="@(#) UFIS44 (c) ABB AAT/I pdehdl.c 4.5.1.1 / 05.07.2004 HAG";
...
static char *prgCmdTxt[] = { "IFR",   "UFR",   "DFR",  "VDG", "VDR", "SETOAL", "RPT", "TMO", "BAT", "POR", "BATE", "REQ",NULL };
static int    rgCmdDef[] = { CMD_IFR, CMD_UFR,CMD_DFR,CMD_VDG, CMD_VDR, CMD_SETOAL, CMD_REPEAT, CMD_TMO, CMD_BATCH, CMD_PORTAL, CMD_BATCH_EFPS,CMD_REQ,0 };
...
static int Init_Pdehdl()
{
  ...
  SetSignals(HandleSignal);
    ...
    if(ilRc == RC_SUCCESS)
    {
        ...
        /* MEI v1.19 */
        igSpecialRangeFromInbound = 0;      igSpecialRangeFromOutbound = 0;
        igSpecialRangeToInbound = 0;        igSpecialRangeToOutbound = 0;
  ...
  char clFlightUrno[24];
    ...
    for(ilUrnoLc = 1; ilUrnoLc <= ilUrnoCount; ilUrnoLc++)
    {
        ...
        CEDAArrayGetField(&rgAftArrayInbound.rrArrayHandle,rgAftArrayInbound.crArrayName,
            ...
            CEDAArrayGetField(&rgAftArrayInbound.rrArrayHandle,rgAftArrayInbound.crArrayName,
                 &llFieldNo , clFina ,1023, ARR_CURRENT,clTmpFieldBuf);
...
static int UpdDemUtpl ()
{
    ...
    if ( ilRc == RC_SUCCESS )
    {   /* Activate loading of demands with DEMTAB.UTPL */
...
static int SendBatch( int igCmd )
{
    char pclSqlBuf[1024];
    char pclNow[20] = "\0";
    char pclFrom[20] = "\0";
