...
#include "ufisvers.h" /* sets UFIS_VERSION, must be done before mks_version */
  static char mks_version[] = "@(#) "UFIS_VERSION" $Id: Ufis/_Standard/_Standard_Server/Base/Server/Kernel/pdehdl.c 1.26c 2015/01/26 9:52:56SGT fya Exp  $";
...
static int Init_Pdehdl() {
	...
	setHomeAirport(cgProcessName, cgHopo);
